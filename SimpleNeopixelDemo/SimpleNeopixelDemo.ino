...
#define NS_TO_CYCLES(n) (( (n+(NS_PER_CYCLE/2)) / NS_PER_CYCLE )-1)		// Round up or down to the nearest matching number of cycles
...
void show() {
	...
	_delay_us( (RES / 1000UL) + 1);				// Round up to nearest us since the delay must be _at_least_ this long (too short might not work, too long not a problem)
